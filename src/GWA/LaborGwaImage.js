...
registerDependencies({
  'mj-body': ['labor-gwa-image'],
  'labor-gwa-image': [],
})

export default class LaborGwaImage extends BodyComponent {
  ...
  render() {
    ...
    let imgAttrs = {
      ...
      'align': 'left',
      'css-class': this.getAttribute('with-padding') ? 'labor-gwa-image-responsive' : '',
