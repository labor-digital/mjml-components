...
export default class LaborAdobeTypoHeadingFour extends BodyComponent {
  ...
  render() {
    const attrs = {
      ...
      'color': this.getAttribute('on-background') ? LaborAdobeTypoHeadingFour.additionalAttributes.onBackgroundColor : LaborAdobeTypoHeadingFour.additionalAttributes.color,
